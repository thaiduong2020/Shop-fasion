...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-light  " style="background-color: #ff971b!important ;height: 43px;"
  ...
  <div class="row mx-auto">
      <div class="col-md-3 ml-5" >
        <div class="list-group">
            <button type="button" class="list-group-item list-group-item-action active border text-dark" style="height: 43px;background-color:#ff971b!important; border-color: #ff971b!important;">
      ...
      <div class="col-md-7">
          <img src="{{ 'upload/slider_1.jpg' }}" alt="">
      </div>
  </div>
  ...
  <div class="row">
        <div class="col-md-11 mx-auto mt-3" style="background-color: #ffffff; height: 70px;">
